...
class Constants:
    ...
    fnCharList = r'./data/model/charList.txt'
    fnAnalyze = r'./data/analyze.png'
    fnPixelRelevance = r'./data/pixelRelevance.npy'
    fnTranslationInvariance = r'./data/translationInvariance.npy'
    fnTranslationInvarianceTexts = r'./data/translationInvarianceTexts.pickle'
    gtText = 'are'
